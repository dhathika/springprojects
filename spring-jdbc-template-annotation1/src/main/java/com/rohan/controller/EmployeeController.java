...
import com.rohan.config.ApplicationConfig;
import com.rohan.model.Employee;
import com.rohan.service.EmployeeService;
import com.rohan.service.EmployeeServiceImpl;
...
public class EmployeeController {
	...
	public static void main(String[] args) {
		...
		case 1:
			System.out.println("Enter employee details to save it in db");
		...
		case 5:
			System.out.println("Find all Employees to select one Employee to update");
