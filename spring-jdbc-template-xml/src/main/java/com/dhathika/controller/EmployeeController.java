...
public class EmployeeController {
	...
	public static void main(String[] args) {
		...
		case 1: System.out.println("Enter employee details to save it in db");
			...
			break;
		case 2:System.out.println("Enter the employee details by using employeeid");
			   int empid = sc.nextInt();
		       Employee selectedemployee = employeService.selectEmployeeByIdService(empid);
		       System.out.println(selectedemployee);
		       break;
		case 3:System.out.println("delete employee by using empId");
			  System.out.println("enter the empId");
			   int deleteid = sc.nextInt();
			   employeService.deleteEmployeeByIdService(deleteid);
			   System.out.println("deleted one employee from the table");
			   break;
